...
{
    /// <summary>
    /// Smart procedural terrain cube with control points
    ...
    public class SmartTerrain : MonoBehaviour
    {
        ...
        [Tooltip("Control point that defines the terrain size")]
        public Transform controlPoint;

        [Header("Settings")]
        [SerializeField] private Vector3 minSize = new Vector3(1f, 0.5f, 1f);
        ...
        private void Awake()
        {
            ...
            if (terrainMesh == null)
            {
                ...
                terrainMesh.name = "SmartTerrainMesh";
                if (meshFilter != null)
            ...
            if (meshRenderer != null)
            {
                ...
                else
                {
                    ...
                    if (urpShader != null)
                    {
                        terrainMaterial = new Material(urpShader);
                        terrainMaterial.name = "DefaultTerrainMaterial";
                        terrainMaterial.color = new Color(0.5f, 0.5f, 0.5f); // Grey color
                        meshRenderer.material = terrainMaterial;
                    }
                }
            }
        ...
        private void OnDestroy()
        {
            ...
            {
                SmartTerrainManager.Instance.UnregisterTerrain(this);
            }
        }
        ...
        private void CreateControlPoint()
        {
            ...
            cpObj.transform.localPosition = new Vector3(2f, 1f, 2f); // Smaller default size
        ...
        /// <summary>
        /// Update the terrain mesh based on control point position
        /// </summary>
        public void UpdateMesh()
        {
            if (controlPoint == null || terrainMesh == null)
                return;
